...
namespace CustomerManagementPortal.Controllers
{
    ...
    public class CustomerModelsController : Controller
    {
        ...
        public ActionResult Index(int page = 1, int pageSize = 10)
        {
            ...
            var models = service.GetCustomers().ToPagedList(page, pageSize);
            return View(models);
        }
        ...
        public ActionResult Create([Bind(Include = "CustomerId,Name,Email,Tel")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,Name,Email,Tel,Comment")] CustomerModel customerModel)
        {
            if (ModelState.IsValid)
            {
